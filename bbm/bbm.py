    ...
    def branche(self,b_cote:urs.Entity,cote:str,wt1,wt2,wt3,wt4):
        for i in range(self.longueur):
            ...
            # mur cassable : on le casse et on créer un bout, puis on stoppe le rayon
                ...
                new_sprite = urs.Entity(scale=self.scale,model='quad',collider='box',parent=b_cote) ; new_sprite.x += i+1
            ...
            # si aucun mur :
                ...
                new_sprite = urs.Entity(scale=self.scale,model='quad',collider='box',parent=b_cote) ; new_sprite.x += i+1 ; new_sprite.texture = self.__tex_folder+cote+'11'
